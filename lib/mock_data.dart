final mockData = [
  {
    'name': 'Erbil',
    'imageURL':
        'https://upload.wikimedia.org/wikipedia/commons/8/8d/%D8%A3%D8%B1%D8%A8%D9%8A%D9%84_%22%D8%B9%D8%A7%D8%B5%D9%85%D8%A9_%D8%A7%D9%84%D9%8A%D8%A7%D8%AD%D8%A9_%D8%A7%D9%84%D8%B9%D8%B1%D8%A7%D9%82%D9%8A%D8%A9%22.jpg',
    'description':
        'Erbil, also called Hawler (Kurdish: ھەولێر ,Hewlêr[3] Arabic: أربيل, romanized: Arbīl,[4] Syriac: ܐܲܪܒܹܝܠ,[5] or Arbel) and known in ancient history as Arbela, is the capital and most populated city in the Kurdistan Region of Iraq. There is no current census of the city and official population statistics are not available, its population is estimated to be around 1,600,000.',
  },
  {
    'name': 'Sulaymaniyah',
    'imageURL':
        'https://upload.wikimedia.org/wikipedia/commons/2/23/View_of_Sulaimani_-_Slemani_-_City_in_Southern_Kurdistan_in_Spring_2016.JPG',
    'description':
  ...
  {
    'name': 'Koya',
    'imageURL': 'https://upload.wikimedia.org/wikipedia/commons/f/f2/Koye.JPG',
    'description':
